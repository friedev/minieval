...
func _on_GameVolume_value_changed(value):
	...
	AudioServer.set_bus_volume_db(AudioServer.get_bus_index("Background music"), volume_values[value])

func _on_SFXVolume_value_changed(value):
	Global.sfx_volume = value
	AudioServer.set_bus_volume_db(AudioServer.get_bus_index("Sound Effects"), volume_values[value])
